...
`)}injectContentLoadedListener(t,e,n){n.length!==0&&(t instanceof HTMLIFrameElement?this.injectContentLoadedListenerForIframe(t,e,n):t.tagName==="WEBVIEW"&&this.injectContentLoadedListenerForWebView(t,e,n))}injectContentLoadedListenerForIframe(t,e,n){try{if(!t.contentWindow||!t.contentDocument){console.warn("\u65E0\u6CD5\u8BBF\u95EEiframe\u5185\u5BB9\u6765\u8BBE\u7F6EDOMContentLoaded\u76D1\u542C\u5668");let r=setInterval(()=>{try{t.contentDocument&&t.contentDocument.readyState==="interactive"&&(clearInterval(r),n.forEach(i=>this.injectScript(t,e,i)))}catch(i){clearInterval(r)}},100);setTimeout(()=>clearInterval(r),1e4);return}t.contentDocument.readyState==="loading"?t.contentDocument.addEventListener("DOMContentLoaded",async()=>{for(let r of n)await this.injectScript(t,e,r)}):n.forEach(r=>this.injectScript(t,e,r))}catch(r){console.error("\u8BBE\u7F6Eiframe\u7684DOMContentLoaded\u76D1\u542C\u5668\u5931\u8D25:",r),n.forEach(i=>this.injectScript(t,e,i))}}injectContentLoadedListenerForWebView(t,e,n){let r=`
        ...
        `;this.executeScript(t,r);let i=c=>{n.forEach(a=>this.injectScript(t,e,a))};t.addEventListener("obsidian-cheekychimp-load",i),setTimeout(()=>{t.removeEventListener("obsidian-cheekychimp-load",i)},1e4)}executeScript(t,e){return new Promise((n,r)=>{try{t instanceof HTMLIFrameElement?this.executeScriptInIframe(t,e).then(n).catch(r):t.tagName==="WEBVIEW"?this.executeScriptInWebView(t,e).then(n).catch(r):(console.warn("\u4E0D\u652F\u6301\u7684webview\u7C7B\u578B:",t.tagName),r(new Error("\u4E0D\u652F\u6301\u7684webview\u7C7B\u578B")))}catch(i){console.error("\u6267\u884C\u811A\u672C\u65F6\u51FA\u9519:",i),r(i)}})}executeScriptInIframe(t,e){return new Promise((n,r)=>{var i;try{if(!t.contentWindow||!t.contentDocument){console.warn("CheekyChimp: \u65E0\u6CD5\u8BBF\u95EEiframe\u5185\u5BB9\uFF0C\u53EF\u80FD\u662F\u8DE8\u57DF\u9650\u5236"),this.tryExecuteViaURL(t,e).then(n).catch(r);return}try{let c=t.contentDocument.createElement("script");c.textContent=e,c.setAttribute("data-cheekychimp","true"),c.setAttribute("type","text/javascript"),console.log("CheekyChimp: \u6B63\u5728\u6CE8\u5165\u811A\u672C\u5230iframe"),t.contentDocument.head?(t.contentDocument.head.appendChild(c),console.log("CheekyChimp: \u811A\u672C\u5DF2\u6CE8\u5165\u5230iframe head"),t.src.includes("bilibili.com")&&(console.log("CheekyChimp: \u68C0\u6D4B\u5230B\u7AD9\u9875\u9762\uFF0C\u8BBE\u7F6EDOM\u53D8\u5316\u76D1\u542C\u5668"),this.setupBilibiliSupport(t))):t.contentDocument.documentElement?(t.contentDocument.documentElement.appendChild(c),console.log("CheekyChimp: \u811A\u672C\u5DF2\u6CE8\u5165\u5230iframe documentElement")):((i=t.contentDocument.body)==null||i.appendChild(c),console.log("CheekyChimp: \u811A\u672C\u5DF2\u6CE8\u5165\u5230iframe body"))}catch(c){console.error("CheekyChimp: \u901A\u8FC7DOM\u65B9\u5F0F\u6CE8\u5165\u811A\u672C\u5931\u8D25:",c),this.tryExecuteViaEval(t,e).then(n).catch(r)}}catch(c){console.error("CheekyChimp: \u65E0\u6CD5\u5728iframe\u4E2D\u6267\u884C\u811A\u672C\uFF0C\u53EF\u80FD\u662F\u8DE8\u57DF\u9650\u5236:",c),this.tryExecuteViaURL(t,e).then(n).catch(r)}})}setupBilibiliSupport(t){try{if(!t.contentDocument)return;let e=new MutationObserver(n=>{var i;if((i=t.contentDocument)==null?void 0:i.querySelector(".bpx-player-ctrl-playbackrate")){console.log("CheekyChimp: B\u7AD9\u64AD\u653E\u5668\u5DF2\u52A0\u8F7D\uFF0C\u91CD\u65B0\u6267\u884C\u76F8\u5173\u811A\u672C");let c=t.src,a=this.scriptManager.findScriptsForUrl(c).filter(h=>h.matches.some(u=>u.includes("bilibili.com")));for(let h of a)this.injectScript(t,c,h);e.disconnect()}});e.observe(t.contentDocument.body,{childList:!0,subtree:!0}),console.log("CheekyChimp: \u5DF2\u8BBE\u7F6EB\u7AD9\u9875\u9762\u7684DOM\u76D1\u542C\u5668")}catch(e){console.error("CheekyChimp: \u8BBE\u7F6EB\u7AD9\u7279\u6B8A\u652F\u6301\u5931\u8D25:",e)}}tryExecuteViaEval(t,e){return new Promise((n,r)=>{try{if(t.contentWindow){console.log("CheekyChimp: \u5C1D\u8BD5\u901A\u8FC7eval\u65B9\u5F0F\u6267\u884C\u811A\u672C");try{let c=new Function(`
                            try {
                        ...
                        `)();console.log("CheekyChimp: \u901A\u8FC7Function\u6784\u9020\u5668\u6CE8\u5165\u811A\u672C"+(c?"\u6210\u529F":"\u5931\u8D25")),n()}catch(i){console.error("CheekyChimp: Function\u6784\u9020\u5668\u6267\u884C\u5931\u8D25",i),r(i)}}}catch(i){console.error("CheekyChimp: \u901A\u8FC7eval\u6267\u884C\u811A\u672C\u5931\u8D25:",i),r(i)}})}tryExecuteViaURL(t,e){return new Promise((n,r)=>{try{console.log("CheekyChimp: \u5C1D\u8BD5\u901A\u8FC7URL\u65B9\u5F0F\u6CE8\u5165\u811A\u672C");let i=new Blob([e],{type:"text/javascript"}),c=URL.createObjectURL(i),a;try{t.contentDocument?a=t.contentDocument.createElement("script"):a=document.createElement("script")}catch(h){a=document.createElement("script")}a.src=c,a.type="text/javascript",a.setAttribute("data-cheekychimp","true");try{if(t.contentDocument&&t.contentDocument.head)t.contentDocument.head.appendChild(a),console.log("CheekyChimp: \u901A\u8FC7Blob URL\u6CE8\u5165\u811A\u672C\u5230head\u6210\u529F");else if(t.contentDocument&&t.contentDocument.body)t.contentDocument.body.appendChild(a),console.log("CheekyChimp: \u901A\u8FC7Blob URL\u6CE8\u5165\u811A\u672C\u5230body\u6210\u529F");else{let h=`<script src="${c}" type="text/javascript" data-cheekychimp="true"><\/script>`,u=document.createElement("iframe");u.style.display="none",u.onload=function(){var f;try{let o=u.contentDocument||((f=u.contentWindow)==null?void 0:f.document);o&&(o.open(),o.write(h),o.close(),console.log("CheekyChimp: \u901A\u8FC7\u6CE8\u5165iframe\u6267\u884C\u811A\u672C\u6210\u529F"))}catch(o){console.error("CheekyChimp: iframe\u6CE8\u5165\u5931\u8D25:",o),r(o)}},document.body.appendChild(u),console.log("CheekyChimp: \u521B\u5EFA\u6CE8\u5165\u7528iframe\u6210\u529F")}}catch(h){console.error("CheekyChimp: \u65E0\u6CD5\u901A\u8FC7Blob URL\u65B9\u5F0F\u6CE8\u5165:",h),r(h)}setTimeout(()=>URL.revokeObjectURL(c),5e3)}catch(i){console.error("CheekyChimp: \u901A\u8FC7URL\u6CE8\u5165\u5C1D\u8BD5\u5931\u8D25:",i),r(i)}})}executeScriptInWebView(t,e){return new Promise((n,r)=>{try{let i=t;typeof i.executeJavaScript=="function"?i.executeJavaScript(e).then(()=>n()).catch(c=>{console.warn("CheekyChimp: \u901A\u8FC7executeJavaScript\u6CE8\u5165\u5931\u8D25\uFF0C\u5C1D\u8BD5\u5907\u7528\u65B9\u6CD5",c),this.fallbackScriptInjection(t,e).then(n).catch(r)}):this.fallbackScriptInjection(t,e).then(n).catch(r)}catch(i){console.error("CheekyChimp: \u6267\u884C\u811A\u672C\u5931\u8D25:",i),r(i)}})}fallbackScriptInjection(t,e){return new Promise(async(n,r)=>{try{let i=t;if(typeof i.insertCSS=="function")try{await i.executeJavaScript(e),n();return}catch(c){console.warn("CheekyChimp: \u4F7F\u7528Electron webview\u65B9\u6CD5\u6CE8\u5165\u5931\u8D25",c)}try{if(i.contentWindow){let c=document.createElement("script");c.textContent=e,i.contentWindow.document.head.appendChild(c),n();return}}catch(c){console.warn("CheekyChimp: \u4F7F\u7528contentWindow\u6CE8\u5165\u5931\u8D25",c)}if(typeof i.send=="function")try{i.send("obsidian-cheekychimp-inject",{script:e,id:Math.random().toString(36).substr(2,9)}),n();return}catch(c){console.warn("CheekyChimp: \u4F7F\u7528\u4E8B\u4EF6\u4F20\u9012\u6CE8\u5165\u5931\u8D25",c)}r(new Error("CheekyChimp: \u6240\u6709\u6CE8\u5165\u65B9\u6CD5\u90FD\u5931\u8D25\u4E86"))}catch(i){console.error("CheekyChimp: \u5907\u7528\u6CE8\u5165\u65B9\u6CD5\u5931\u8D25:",i),r(i)}})}registerMenuCommand(t,e,n,r){try{let i=Date.now()+Math.floor(Math.random()*1e3),c=`tampermonkey_commands:${t.id}`,a=[];try{let u=localStorage.getItem(c);u&&(a=JSON.parse(u))}catch(u){console.error("\u89E3\u6790\u4FDD\u5B58\u7684\u547D\u4EE4\u5931\u8D25:",u)}a.push({id:i,name:e,accessKey:r||""}),localStorage.setItem(c,JSON.stringify(a)),document.addEventListener(`cheekychimp-run-command-${i}`,()=>{try{n()}catch(u){console.error(`CheekyChimp: \u6267\u884C\u547D\u4EE4 "${e}" \u5931\u8D25:`,u)}});let h=new CustomEvent("cheekychimp-command-registered",{detail:{scriptId:t.id,commandId:i,name:e}});return document.dispatchEvent(h),console.log(`CheekyChimp: \u5DF2\u6CE8\u518C\u83DC\u5355\u547D\u4EE4 "${e}"`),i}catch(i){return console.error(`CheekyChimp: \u6CE8\u518C\u83DC\u5355\u547D\u4EE4 "${e}" \u5931\u8D25:`,i),-1}}extractConnectDomains(t){let e=/\/\/\s*@connect\s+([^\s]+)/g,n=[],r;for(;(r=e.exec(t))!==null;)r[1]&&n.push(r[1].trim());n.push("localhost"),n.push("127.0.0.1");try{let i=window.location.hostname;i&&n.push(i)}catch(i){console.warn("\u65E0\u6CD5\u83B7\u53D6\u5F53\u524D\u57DF\u540D:",i)}return[...new Set(n)]}isConnectAllowed(t,e){if(e.length===0||e.includes(t))return!0;for(let n of e)if(n.startsWith("*.")&&t.endsWith(n.substring(1)))return!0;return!1}generateSimpleGMAPIs(){return`
        // GM \u5B58\u50A8 API
        ...
        `}extractResources(t){let e={requires:[],resources:[]},n=Array.from(t.source.matchAll(/\/\/ @require\s+(https?:\/\/\S+)/g)),r=Array.from(t.source.matchAll(/\/\/ @resource\s+(\S+)\s+(https?:\/\/\S+)/g));return n.forEach(i=>{i[1]&&e.requires.push(i[1])}),r.forEach(i=>{i[1]&&i[2]&&e.resources.push({name:i[1],url:i[2]})}),t.requires&&Array.isArray(t.requires)&&(e.requires=[...new Set([...e.requires,...t.requires])]),t.resources&&typeof t.resources=="object"&&Object.entries(t.resources).forEach(([i,c])=>{typeof c=="string"&&e.resources.push({name:i,url:c})}),e}async loadExternalResource(t){if(this.resourceCache[t])return this.resourceCache[t];try{console.log(`CheekyChimp: \u52A0\u8F7D\u5916\u90E8\u8D44\u6E90 ${t}`);let e=await fetch(t,{cache:"force-cache",headers:{"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36"}});if(!e.ok)throw new Error(`HTTP error! status: ${e.status}`);let n=await e.text();return this.resourceCache[t]=n,console.log(`CheekyChimp: \u5DF2\u52A0\u8F7D\u8D44\u6E90 ${t}`),n}catch(e){return console.error(`CheekyChimp: \u52A0\u8F7D\u8D44\u6E90\u5931\u8D25 ${t}:`,e),""}}async preprocessScript(t){let{requires:e,resources:n}=this.extractResources(t),r=t.source,i="";for(let a of n)try{let h=await this.loadExternalResource(a.url);i+=`
                ...
                `}catch(h){console.error(`CheekyChimp: \u5904\u7406\u8D44\u6E90\u5931\u8D25 ${a.name}:`,h)}let c="";for(let a of e)try{let h=await this.loadExternalResource(a);c+=`
                // \u6CE8\u5165\u4F9D\u8D56: ${a}
                try {
                    ${h}
                } catch(e) {
                ...
                `}catch(h){console.error(`CheekyChimp: \u5904\u7406\u4F9D\u8D56\u5931\u8D25 ${a}:`,h)}return`
        // ==UserScript \u9884\u5904\u7406\u4EE3\u7801==
        (function() {
            // \u8D44\u6E90\u548C\u4F9D\u8D56\u521D\u59CB\u5316
            ${i}
...
(function() {
    ...
    console.log('CheekyChimp script running!');
        ...
        `,document.head.appendChild(e)}updateRibbonIconVisibility(){this.ribbonIconEl&&(this.ribbonIconEl.remove(),this.ribbonIconEl=null),this.settings.showRibbonIcon&&(this.ribbonIconEl=this.addRibbonIcon("cheekychimp","CheekyChimp",e=>{let n=this.scriptManager.getAllScripts().filter(r=>r.enabled);if(n.length>0){let r=n.map(i=>`- ${i.name}`).join(`
`);new C.Notice(`${w.t("active_scripts")} (${n.length}):
${r}`)}else new C.Notice(w.t("no_active_scripts"));this.openSettings()}))}};
